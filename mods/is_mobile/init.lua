...
minetest.register_craftitem("is_mobile:airplane_item", {
    description = "Flugzeug (is_mobile)",
    inventory_image = "is_mobile_flieger_item.png",
    wield_image = "is_mobile_flieger_item.png",
    stack_max = 1,
    ...
    on_place = function(itemstack, placer, pointed_thing)
        ...
        -- Entity spawnen
        local ent = minetest.add_entity(pos, "is_mobile:airplane")
