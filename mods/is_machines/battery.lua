...
function is_machines.update_battery_formspec(pos)
...
minetest.register_node("is_machines:battery", {
    ...
    on_construct = function(pos)
        ...
        is_machines.update_battery_formspec(pos)
    end,
...
function is_machines.charge_battery(pos, amount)
    local meta = minetest.get_meta(pos)
