-- =======================================================================
-- Industrial Survival MACHINES - INITIALISIERUNG & KERN-LOGIK
-- =======================================================================
...
function is_machines.push_energy_network(start_pos, energy_available)
    local visited = {}
    local consumers = {}
...
local modpath = minetest.get_modpath("is_machines")
...
minetest.log("action", "[is_machines] Mod erfolgreich geladen! (Pumpe, Generator, Batterie, E-Ofen)")
