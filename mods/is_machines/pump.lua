-- =======================================================================
-- Industrial Survival MACHINES - DAMPFPUMPE (MIT INTERNEM TANK & STATUS-MONITOR)
-- =======================================================================
...
function is_machines.update_pump_formspec(pos)
...
minetest.register_node("is_machines:steam_pump", {
    ...
    on_construct = function(pos)
        ...
        is_machines.update_pump_formspec(pos)
    end,
    ...
    on_receive_fields = function(pos, formname, fields, sender)
        ...
        if changed then is_machines.update_pump_formspec(pos) end
    end,
