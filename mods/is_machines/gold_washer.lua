-- =======================================================================
-- Industrial Survival MACHINES - GOLDWASCHANLAGE (INTELLIGENTE SEITENSTEUERUNG)
-- =======================================================================
...
minetest.register_node("is_machines:gold_washer", {
    ...
    on_timer = function(pos, elapsed)
        ...
        local recipe = is_machines.washer_recipes[input_name]
