...
minetest.register_node("is_machines:alloy_smelter", {
    ...
    on_timer = function(pos, elapsed)
        ...
        if (s1 == "is_core:ingot_copper" and s2 == "is_core:ingot_tin") or
           (s1 == "is_core:ingot_tin" and s2 == "is_core:ingot_copper") then
