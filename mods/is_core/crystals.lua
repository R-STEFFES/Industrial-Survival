...
for _, c in ipairs(crystal_colors) do
    local nodename = "is_core:crystal_" .. c.name
    local itemname = "is_core:crystal_shard_" .. c.name

    -- Für den Mapgen exportieren
    table.insert(is_core.crystals, nodename)
    ...
    minetest.register_node(nodename, {
        ...
        drawtype = "plantlike",
        visual_scale = 0.8,
        tiles = {"is_core_crystal.png^[multiply:" .. c.color},
        inventory_image = "is_core_crystal.png^[multiply:" .. c.color,
        paramtype = "light",
    ...
    minetest.register_craftitem(itemname, {
        ...
        inventory_image = "is_core_crystal_shard.png^[multiply:" .. c.color,
    })
    ...
    for _, t in ipairs(tools) do
        local tool_texture = "is_core_tool_head_" .. t[1] .. ".png^[multiply:" .. c.color .. "^is_core_" .. t[1] .. "_handle.png"

        minetest.register_tool("is_core:" .. t[1] .. "_crystal_" .. c.name, {
    ...
    for _, arm in ipairs(armor_types) do
        armor:register_armor("is_core:" .. arm.suffix .. "_crystal_" .. c.name, {
            description = c.desc .. " Kristall-" .. arm.desc,
            inventory_image = "is_core_inv_" .. arm.suffix .. ".png^[multiply:" .. c.color,
            texture = "is_core_armor_" .. arm.suffix .. ".png^[multiply:" .. c.color .. "^[combine:1x1:0,0=blank",
            preview = "is_core_preview_" .. arm.suffix .. ".png^[multiply:" .. c.color .. "^[combine:1x1:0,0=blank",
            groups = {
                armor = 1,
                [arm.element] = 1,
    ...
    -- Tools
    minetest.register_craft({ output = "is_core:pick_crystal_" .. c.name, recipe = {{itemname, itemname, itemname}, {"", stick, ""}, {"", stick, ""}} })
    minetest.register_craft({ output = "is_core:axe_crystal_" .. c.name, recipe = {{itemname, itemname, ""}, {itemname, stick, ""}, {"", stick, ""}} })
    minetest.register_craft({ output = "is_core:shovel_crystal_" .. c.name, recipe = {{itemname, "", ""}, {stick, "", ""}, {stick, "", ""}} })
    minetest.register_craft({ output = "is_core:sword_crystal_" .. c.name, recipe = {{itemname, "", ""}, {itemname, "", ""}, {stick, "", ""}} })

    -- Armor
    minetest.register_craft({ output = "is_core:helmet_crystal_" .. c.name, recipe = {{itemname, itemname, itemname}, {itemname, "", itemname}} })
    minetest.register_craft({ output = "is_core:chestplate_crystal_" .. c.name, recipe = {{itemname, "", itemname}, {itemname, itemname, itemname}, {itemname, itemname, itemname}} })
    minetest.register_craft({ output = "is_core:leggings_crystal_" .. c.name, recipe = {{itemname, itemname, itemname}, {itemname, "", itemname}, {itemname, "", itemname}} })
    minetest.register_craft({ output = "is_core:boots_crystal_" .. c.name, recipe = {{itemname, "", itemname}, {itemname, "", itemname}} })
end
