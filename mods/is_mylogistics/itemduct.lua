...
local function open_upgrade_formspec(pos, player, upgrade_type, dir_str)
    ...
    minetest.show_formspec(
        ...
        "is_mylogistics:upgrade_" .. pos_string,
        formspec
    )
end
...
minetest.register_craftitem("is_mylogistics:servo", {
    ...
    on_place = function(itemstack, placer, pointed_thing)
        ...
        minetest.swap_node(pos, {name = "is_mylogistics:itemduct" .. is_trans .. "_servo_" .. dir_str})
        local meta = minetest.get_meta(pos)
...
minetest.register_craftitem("is_mylogistics:filter", {
    description = "Filter\nRechtsklicke ein Rohr neben einer Kiste, um es anzuheften.",
    ...
    on_place = function(itemstack, placer, pointed_thing)
        ...
        minetest.swap_node(pos, {name = "is_mylogistics:itemduct" .. is_trans .. "_filter_" .. dir_str})
        local meta = minetest.get_meta(pos)
...
for _, t in ipairs(DUCT_TYPES) do
    minetest.register_node("is_mylogistics:itemduct" .. t.suffix, {
        description = t.desc,
        drawtype = "nodebox",
        paramtype = "light",
    ...
    for dname, data in pairs(DIRS_DATA) do
        ...
        minetest.register_node("is_mylogistics:itemduct" .. t.suffix .. "_servo_" .. dname, {
        ...
        minetest.register_node("is_mylogistics:itemduct" .. t.suffix .. "_filter_" .. dname, {
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
    if string.sub(formname, 1, 20) ~= "is_mylogistics:upgrade_" then return end
