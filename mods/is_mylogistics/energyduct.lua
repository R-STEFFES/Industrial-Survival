...
minetest.register_node("is_mylogistics:cable", {
    ...
    connects_to = {"is_mylogistics:cable", "group:technic_machine", "group:machine_power"},
    ...
    on_timer = function(pos, elapsed)
        ...
        for _, dir in ipairs(directions) do
            ...
            if n_def then
                ...
                if n_name == "is_mylogistics:cable" then
                ...
                for _, consumer in ipairs(consumers) do
                    ...
                    if to_give > 0 then
                        ...
                        for _, source_pos in ipairs(sources) do
                            if is_machines and is_machines.draw_energy_from_node then
                                local p = is_machines.draw_energy_from_node(source_pos, to_give - drawn)
                                drawn = drawn + p
