...
minetest.register_ore({
    ore_type          = "stratum",
    ore               = "is_core:limestone",
    wherein           = {"is_core:stone"},
    clust_scarcity    = 1,
    y_max             = -20,
    y_min             = -80,
    noise_params      = {
...
minetest.register_ore({
    ore_type        = "blob",
    ore             = "is_core:gravel_coarse",
    wherein         = {"is_core:stone","is_core:limestone"},
...
minetest.register_ore({
    ore_type        = "blob",
    ore             = "is_core:basalt",
    wherein         = {"is_core:stone","is_core:granite"},
...
minetest.log("action", "[is_terrain] Geologische Schichten registriert.")
