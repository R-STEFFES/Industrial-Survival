...
if mg_name == "v6" then
    minetest.log("action", "[is_terrain] v6-Mapgen: Biom-Dekorationen übersprungen.")
    return
end
...
register_boulder(
    "is_core:limestone",
    {"default:dirt_with_grass","is_core:loam_brown","is_core:gravel_coarse"},
...
register_boulder(
    "is_core:granite",
    {"is_core:granite","is_core:gravel_coarse","default:dirt_with_grass"},
...
register_boulder(
    "is_core:granite",
    {"default:dirt_with_grass","is_core:loam_brown","is_core:gravel"},
...
register_boulder(
    "is_core:basalt",
    {"default:dirt_with_grass","is_core:loam_red","is_core:stone"},
...
minetest.register_decoration({
    deco_type  = "simple",
    place_on   = {"is_core:gravel","is_core:gravel_coarse","is_core:sand"},
    sidelen    = 8,
    fill_ratio = 0.05,
    biomes     = {"st_beach","st_alpine","st_tundra"},
    y_max      = 40,
    y_min      = -2,
    decoration = "is_core:gravel_coarse",
})
...
minetest.register_decoration({
    deco_type  = "simple",
    place_on   = {"is_core:sand","is_core:silt"},
    sidelen    = 4,
    fill_ratio = 0.04,
    biomes     = {"st_beach","st_mudflat"},
    y_max      = 2,
    y_min      = -3,
    decoration = "is_core:gravel",
})
...
minetest.register_decoration({
    deco_type  = "simple",
    place_on   = {"is_core:loam_grey","is_core:loam_brown","default:dirt"},
    sidelen    = 16,
    noise_params = {
        offset   = -0.3,
        scale    = 0.7,
...
minetest.register_decoration({
    deco_type  = "simple",
    place_on   = {"is_core:silt","is_core:loam_grey"},
    sidelen    = 4,
    fill_ratio = 0.06,
    biomes     = {"st_mudflat","st_swamp"},
    y_max      = 1,
    y_min      = -2,
    decoration = "is_core:clay",
    place_offset_y = -1,
    flags = "force_placement",
})
...
minetest.register_decoration({
    deco_type  = "simple",
    place_on   = {"is_core:granite","is_core:gravel_coarse"},
    sidelen    = 4,
    fill_ratio = 0.08,
    ...
    decoration = {
        "is_core:granite",
        "is_core:stone",
        "is_core:gravel_coarse",
    },
})

minetest.log("action", "[is_terrain] Dekorationen registriert.")
