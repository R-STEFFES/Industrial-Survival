...
local modpath = minetest.get_modpath("is_terrain")
local mg_name = minetest.get_mapgen_setting("mg_name")

minetest.log("action", "[is_terrain] Lade realistischen Weltgenerator (Mapgen: " .. mg_name .. ")")
...
if mg_name == "singlenode" then
    ...
    -- SINGLENODE-PFAD
    ----------------------------------------------------------------------------
    minetest.log("action", "[is_terrain] Singlenode-Modus: Custom Terrain Generator Pipeline aktiv.")
    ...
    ----------------------------------------------------------------------------
    minetest.log("action", "[is_terrain] Normaler Mapgen-Modus (" .. mg_name .. "): Standard-Pipeline aktiv.")
...
minetest.log("action", "[is_terrain] Weltgenerator vollständig geladen.")
